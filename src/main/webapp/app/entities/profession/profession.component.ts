...
export class ProfessionComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: IProfession) {
        return item.id;
    }

    registerChangeInProfessions() {
        this.eventSubscriber = this.eventManager.subscribe('professionListModification', response => this.reset());
    }
    ...
    protected paginateProfessions(data: IProfession[], headers: HttpHeaders) {
